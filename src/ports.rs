...
pub fn default_ports() -> Vec<u16> {
    ...
    const DEFAULT: &[u16] = &[
        // Core infra
        20, 21, 22, 23, 25, 53, 67, 68, 69, 80, 110, 111, 123, 135, 137, 138, 139, 143, 161, 179, 389, 427,
        443, 445, 465, 500, 512, 513, 514, 515, 520, 554, 587, 631, 636, 853, 873, 902, 989, 990, 993, 995,
        // App servers / DBs / queues
        1025, 1080, 1194, 1433, 1434, 1521, 1723, 1883, 2049, 2082, 2083, 2086, 2087, 2181, 2375, 2376, 2380,
        2483, 2484, 27017, 27018, 27019, 28017, 3000, 3128, 3260, 3306, 3333, 3389, 3478, 4000, 4040, 4369,
        4444, 4500, 4567, 5000, 5001, 5040, 5050, 5060, 5061, 5432, 5555, 5671, 5672, 5696, 5900, 5901, 5984,
        5985, 5986, 6000, 6080, 61616, 6379, 6380, 6443, 6666, 6667, 7001, 7002, 7199, 7200, 7777, 8000, 8001,
        8008, 8009, 8010, 8080, 8081, 8088, 8089, 8090, 8161, 8181, 8200, 8222, 8333, 8443, 8500, 8529, 8888,
        9000, 9001, 9042, 9071, 9090, 9091, 9092, 9100, 9200, 9300, 9418, 9443, 9500, 9600, 9666, 9999, 10000,
        11211,
    ];
    DEFAULT.to_vec()
}
